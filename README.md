# PIP PES
A collection of Permutationally Invariant Polynomial Potential Energy Surfaces written in Fortran, interfaced with i-PI unless indicated (to be done). This collection will be regularly expanded and updated. Virtually all are at the CCSD(T) level and for single gas-phase molecules, unless stated explicitly. 
