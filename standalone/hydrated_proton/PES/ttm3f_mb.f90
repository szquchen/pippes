subroutine ttm3f_mb(Nw,RR,dRR,En)
...
double precision, dimension(4),intent(out) :: En
integer :: fO, lO, fH, lH, fM, lM, fO3, lO3, fH3, lH3, fM3, lM3
integer :: Nw_old
integer :: Nats, Natsd, Natsq
double precision, dimension(3, 3*Nw+1:4*Nw):: RM, dRM
double precision, dimension(9*Nw+1:12*Nw, 9*Nw+1:12*Nw):: DDT
double precision, dimension( 9*Nw+1:12*Nw ):: dip, pr_dip, Efd
double precision, dimension( 1:12*Nw ):: Efq
double precision, dimension( 1:4*Nw ):: charge
double precision, dimension( Nw+1:4*Nw ):: phi
double precision, dimension(Nw, 3, 3, 3) :: grdq
!
