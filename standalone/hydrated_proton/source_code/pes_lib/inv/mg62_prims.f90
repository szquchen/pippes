...
if (size(r,1).ne.nk.or.size(r,2).ne.nk.or.size(u).ne.nr) then
 stop 'mg62_prims: bad dimensions'
endif
...
u = (/ u0(0), u1(0), u2(0), &
  ...
  u0(3), u0(4), u0(5), u0(6), u1(4), u1(5), &
  u0(7), u0(8), u0(9), u1(6), u1(7), &
  u0(10), u0(11), u0(12), u1(8), &
  u0(13), u0(14), u1(9), u1(10), &
  u1(11) /)
return
END SUBROUTINE mg62_prims
