SUBROUTINE mg33211_prims (r, u)
real (kind=wp), intent (in) :: r(0:,0:)
real (kind=wp), intent (out) :: u(0:)
!-----------------------------------------------------------------------
integer, parameter :: m=3, n=3, l=2, m2=m*(m-1)/2, n2=n*(n-1)/2, &
  l2=l*(l-1)/2
integer ib0
...
if (size(r,1).ne.nk.or.size(r,2).ne.nk.or.size(u).ne.nr) then
 stop 'mg33211_prims: bad dimensions'
endif
...
call sym3_prims (x(ib0+m:ib0+m+n-1), u10)
call sym2_prims (x(ib0+m+n:ib0+m+n+l-1), u11)
u12(0:0) = x(ib0+m+n+l:nr-1)
u = (/ u0(0), u1(0), u2(0), u3(0), u4(0), u5(0), &
  u6(0), u7(0), u8(0), &
  u9(0), u10(0), u11(0), u12(0), &
  u0(1), u1(1), u1(2), u1(3), u2(1), u3(1), u3(2), u3(3), &
  u4(1), u4(2), u4(3), u6(1), u7(1), u8(1), u9(1), u10(1), u11(1), &
  u0(2), u1(4), u1(5), u1(6), u2(2), u3(4), u4(4), &
  u6(2), u7(2), u9(2), u10(2), &
  u1(7), u1(8), u3(5), u4(5), u9(3), u10(3) /)
return
END SUBROUTINE mg33211_prims
