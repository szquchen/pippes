...
if (size(r,1).ne.nk.or.size(r,2).ne.nk.or.size(u).ne.nr) then
 stop 'mg51111_prims: bad dimensions'
endif
...
u = (/ u0(0), u1(0), u2(0), u3(0), u4(0), u5(0), u6(0), u7(0), &
  ...
  u0(3), u0(4), u1(2), u2(2), u4(2), u7(2), &
  u0(5), u0(6), u1(3), u2(3), u4(3), u7(3), &
  u0(7), u0(8), u1(4), u2(4), u4(4), u7(4), &
  u0(9) /)
return
END SUBROUTINE mg51111_prims
