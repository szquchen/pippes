SUBROUTINE mg2111111_isecs (mxd, r, pv)
...
if (size(r).ne.nk*nk) then
 stop 'mg2111111_isecs: bad dimensions'
endif
call mgx_setd (r, d)
pv = 0
...
do i0 = 0, m-1
 do i1 = 0, m-1
  if (i1.ne.i0) then
   call mg2111111_all (mxd, mm)
  endif
 enddo
enddo
return
CONTAINS
SUBROUTINE mg2111111_all (mxd, mu)
...
END SUBROUTINE mg2111111_all
END SUBROUTINE mg2111111_isecs
