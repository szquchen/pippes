...
if (size(r,1).ne.nk.or.size(r,2).ne.nk.or.size(u).ne.nr) then
 stop 'mg32211_prims: bad dimensions'
endif
...
call sym3_prims (x(ib0+m+n+l:ib0+2*m+n+l-1), u9)
call sym2_prims (x(ib0+2*m+n+l:ib0+2*m+2*n+l-1), u10)
call sym2_prims (x(ib0+2*m+2*n+l:ib0+2*m+2*n+2*l-1), u11)
u12(0:0) = x(ib0+2*m+2*n+2*l:nr-1)
u = (/ u0(0), u1(0), u2(0), u3(0), u4(0), u5(0), u6(0), u7(0), u8(0), &
  ...
  u0(2), u1(4), u3(4), u6(2), u9(2), &
  u1(5), u3(5) /)
return
END SUBROUTINE mg32211_prims
