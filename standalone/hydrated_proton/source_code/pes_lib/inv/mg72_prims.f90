...
if (size(r,1).ne.nk.or.size(r,2).ne.nk.or.size(u).ne.nr) then
 stop 'mg72_prims: bad dimensions'
endif
...
u = (/ u0(0), u1(0), u2(0), &
  u0(1), u0(2), u1(1), u1(2), u1(3), &
  u0(3), u0(4), u0(5), u0(6), u0(7), u1(4), u1(5), &
  u0(8), u0(9), u0(10), u1(6), u1(7), &
  u0(11), u0(12), u0(13), u1(8), &
  u0(14), u0(15), u1(9), u1(10), &
  u0(16), u0(17), u0(18), u1(11), &
  u0(19), u1(12), &
  u0(20), &
  u1(13) /)
return
END SUBROUTINE mg72_prims
