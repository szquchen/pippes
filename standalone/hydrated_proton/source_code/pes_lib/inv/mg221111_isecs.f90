...
return
CONTAINS
SUBROUTINE mg221111_all (mxd, mu)
...
if (3.le.mxd) then
 pv(20) = pv(20)+d3(i0,j0)/mu
 pv(21) = pv(21)+d2(i0,j0)*d(i0,k0)/mu
 pv(22) = pv(22)+d2(i0,j0)*d(j0,k0)/mu
 pv(23) = pv(23)+d(i0,j0)*d(i0,k0)*d(j0,k0)/mu
 pv(24) = pv(24)+d2(i0,j0)*d(i0,l0)/mu
 pv(25) = pv(25)+d(i0,j0)*d(j0,k0)*d(i0,l0)/mu
 pv(26) = pv(26)+d2(i0,j0)*d(j0,l0)/mu
 pv(27) = pv(27)+d(i0,j0)*d(i0,k0)*d(j0,l0)/mu
 pv(28) = pv(28)+d(i0,j0)*d(i0,l0)*d(j0,l0)/mu
 pv(29) = pv(29)+d2(i0,j0)*d(i0,m0)/mu
 pv(30) = pv(30)+d(i0,j0)*d(j0,k0)*d(i0,m0)/mu
 pv(31) = pv(31)+d(i0,j0)*d(j0,l0)*d(i0,m0)/mu
 pv(32) = pv(32)+d2(i0,j0)*d(j0,m0)/mu
 pv(33) = pv(33)+d(i0,j0)*d(i0,k0)*d(j0,m0)/mu
 pv(34) = pv(34)+d(i0,j0)*d(i0,l0)*d(j0,m0)/mu
 pv(35) = pv(35)+d(i0,j0)*d(i0,m0)*d(j0,m0)/mu
 pv(36) = pv(36)+d2(i0,j0)*d(i0,n0)/mu
 pv(37) = pv(37)+d(i0,j0)*d(j0,k0)*d(i0,n0)/mu
 pv(38) = pv(38)+d(i0,j0)*d(j0,l0)*d(i0,n0)/mu
 pv(39) = pv(39)+d(i0,j0)*d(j0,m0)*d(i0,n0)/mu
 pv(40) = pv(40)+d2(i0,j0)*d(j0,n0)/mu
 pv(41) = pv(41)+d(i0,j0)*d(i0,k0)*d(j0,n0)/mu
 pv(42) = pv(42)+d(i0,j0)*d(i0,l0)*d(j0,n0)/mu
 pv(43) = pv(43)+d(i0,j0)*d(i0,m0)*d(j0,n0)/mu
 pv(44) = pv(44)+d(i0,j0)*d(i0,n0)*d(j0,n0)/mu
endif
END SUBROUTINE mg221111_all
END SUBROUTINE mg221111_isecs
