SUBROUTINE mg32221_prims (r, u)
real (kind=wp), intent (in) :: r(0:,0:)
real (kind=wp), intent (out) :: u(0:)
!-----------------------------------------------------------------------
integer, parameter :: m=3, n=2, l=2, p=2, m2=m*(m-1)/2, n2=n*(n-1)/2, &
...
if (size(r,1).ne.nk.or.size(r,2).ne.nk.or.size(u).ne.nr) then
 stop 'mg32221_prims: bad dimensions'
endif
...
u = (/ u0(0), u1(0), u2(0), u3(0), u4(0), u5(0), u6(0), &
  ...
  u0(2), u1(4), u3(4), u6(4), u10(2), &
  u1(5), u3(5), u6(5) /)
return
END SUBROUTINE mg32221_prims
