...
if (size(r,1).ne.nk.or.size(r,2).ne.nk.or.size(u).ne.nr) then
 stop 'mg42111_prims: bad dimensions'
endif
...
u7(0) = x(ib0+m+n)
call sym4_prims (x(ib0+m+n+1:ib0+2*m+n), u8)
call sym2_prims (x(ib0+2*m+n+1:ib0+2*m+2*n), u9)
u10(0) = x(ib0+2*m+2*n+1)
u11(0:0) = x(ib0+2*m+2*n+2:nr-1)
u = (/ u0(0), u1(0), u2(0), u3(0), u4(0), u5(0), u6(0), u7(0), &
  u8(0), u9(0), u10(0), u11(0), &
  u0(1), u0(2), u1(1), u1(2), u1(3), u3(1), u4(1), u5(1), u6(1), &
  u8(1), u9(1), &
  u0(3), u0(4), u1(4), u3(2), u5(2), u8(2), &
  u0(5), u1(5), u1(6), u3(3), u5(3), u8(3), &
  u1(7) /)
return
END SUBROUTINE mg42111_prims
