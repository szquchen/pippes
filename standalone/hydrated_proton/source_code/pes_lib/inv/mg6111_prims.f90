...
if (size(r,1).ne.nk.or.size(r,2).ne.nk.or.size(u).ne.nr) then
 stop 'mg6111_prims: bad dimensions'
endif
...
u3(0) = x(m2+2*m)
call sym6_prims (x(m2+2*m+1:m2+3*m), u4)
u5(0) = x(m2+3*m+1)
u6(0) = x(m2+3*m+2)
u = (/ u0(0), u1(0), u2(0), u3(0), u4(0), u5(0), u6(0), &
  u0(1), u0(2), u1(1), u2(1), u4(1), &
  u0(3), u0(4), u0(5), u0(6), u1(2), u2(2), u4(2), &
  u0(7), u0(8), u0(9), u1(3), u2(3), u4(3), &
  u0(10), u0(11), u0(12), u1(4), u2(4), u4(4), &
  u0(13), u0(14), u1(5), u2(5), u4(5) /)
return
END SUBROUTINE mg6111_prims
