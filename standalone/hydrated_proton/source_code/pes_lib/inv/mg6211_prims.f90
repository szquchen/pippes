...
if (size(r,1).ne.nk.or.size(r,2).ne.nk.or.size(u).ne.nr) then
 stop 'mg6211_prims: bad dimensions'
endif
...
ib0 = m2+m*n+n2+m+n
call sym6_prims (x(ib0:ib0+m-1), u5)
...
u = (/ u0(0), u1(0), u2(0), u3(0), u4(0), u5(0), u6(0), u7(0), &
  ...
  u0(3), u0(4), u0(5), u0(6), u1(4), u1(5), u3(2), u5(2), &
  u0(7), u0(8), u0(9), u1(6), u1(7), u3(3), u5(3), &
  u0(10), u0(11), u0(12), u1(8), u3(4), u5(4), &
  u0(13), u0(14), u1(9), u1(10), u3(5), u5(5), &
  u1(11) /)
return
END SUBROUTINE mg6211_prims
