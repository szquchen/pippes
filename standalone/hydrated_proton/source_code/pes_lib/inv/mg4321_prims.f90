SUBROUTINE mg4321_prims (r, u)
real (kind=wp), intent (in) :: r(0:,0:)
real (kind=wp), intent (out) :: u(0:)
!-----------------------------------------------------------------------
integer, parameter :: m=4, n=3, l=2, m2=m*(m-1)/2, n2=n*(n-1)/2, &
  l2=l*(l-1)/2
integer :: ib0
...
if (size(r,1).ne.nk.or.size(r,2).ne.nk.or.size(u).ne.nr) then
 stop 'mg4321_prims: bad dimensions'
endif
...
u = (/ u0(0), u1(0), u2(0), u3(0), u4(0), u5(0), u6(0), u7(0), u8(0), &
  ...
  u0(3), u0(4), u1(4), u1(5), u1(6), u2(2), u3(4), u4(4), u6(2), u7(2), &
  u0(5), u1(7), u1(8), u1(9), u3(5), u3(6), u6(3), &
  u1(10), u3(7), u4(5), &
  u1(11) /)
return
END SUBROUTINE mg4321_prims
