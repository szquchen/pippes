...
if (size(r,1).ne.nk.or.size(r,2).ne.nk.or.size(u).ne.nr) then
 stop 'mg211111_prims: bad dimensions'
endif
...
u = (/ u0(0), u1(0), u2(0), u3(0), u4(0), u5(0), u6(0), u7(0), u8(0), &
  u9(0), u10(0), u11(0), u12(0), u13(0), u14(0), u15(0), &
  u1(1), u2(1), u4(1), u7(1), u11(1) /)
return
END SUBROUTINE mg211111_prims
