...
if (size(r,1).ne.nk.or.size(r,2).ne.nk.or.size(u).ne.nr) then
 stop 'mg422_prims: bad dimensions'
endif
...
u = (/ u0(0), u1(0), u2(0), u3(0), u4(0), u5(0), &
  ...
  u4(1), u4(2), u4(3), u0(3), u0(4), u1(4), u3(4), &
  u0(5), u1(5), u1(6), u3(5), u3(6), u1(7), u3(7) /)
return
END SUBROUTINE mg422_prims
