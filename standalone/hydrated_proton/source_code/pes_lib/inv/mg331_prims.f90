...
if (size(r,1).ne.nk.or.size(r,2).ne.nk.or.size(u).ne.nr) then
 stop 'mg331_prims: bad dimensions'
endif
...
u = (/ u0(0), u1(0), u2(0), u3(0), u4(0), &
  u0(1), u1(1), u1(2), u1(3), u2(1), u3(1), u4(1), &
  u0(2), u1(4), u1(5), u1(6), u2(2), u3(2), u4(2), &
  u1(7), u1(8) /)
return
END SUBROUTINE mg331_prims
