...
if (size(r,1).ne.nk.or.size(r,2).ne.nk.or.size(u).ne.nr) then
 stop 'mg311111_prims: bad dimensions'
endif
...
u = (/ u0(0), u1(0), u2(0), u3(0), u4(0), u5(0), u6(0), u7(0), &
  ...
  u0(1), u1(1), u2(1), u4(1), u7(1), u11(1), &
  u0(2), u1(2), u2(2), u4(2), u7(2), u11(2) /)
return
END SUBROUTINE mg311111_prims
