...
if (size(r,1).ne.nk.or.size(r,2).ne.nk.or.size(u).ne.nr) then
 stop 'mg711_prims: bad dimensions'
endif
...
u = (/ u0(0), u1(0), u2(0), u3(0), &
  u0(1), u0(2), u1(1), u2(1), &
  u0(3), u0(4), u0(5), u0(6), u0(7), u1(2), u2(2), &
  u0(8), u0(9), u0(10), u1(3), u2(3), &
  u0(11), u0(12), u0(13), u1(4), u2(4), &
  u0(14), u0(15), u1(5), u2(5), &
  u0(16), u0(17), u0(18), u1(6), u2(6), &
  u0(19), u0(20) /)
return
END SUBROUTINE mg711_prims
