...
if (size(r,1).ne.nk.or.size(r,2).ne.nk.or.size(u).ne.nr) then
 stop 'mg631_prims: bad dimensions'
endif
...
call sym3_prims (x(m2+m*n+n2+m:nr-1), u4)
u = (/ u0(0), u1(0), u2(0), u3(0), u4(0), &
  u0(1), u0(2), u1(1), u1(2), u1(3), u2(1), u3(1), u4(1), &
  u0(3), u0(4), u0(5), u0(6), u1(4), u1(5), u1(6), u2(2), u3(2), u4(2), &
  u0(7), u0(8), u0(9), u1(7), u1(8), u1(9), u1(10), u3(3), &
  u0(10), u0(11), u0(12), u1(11), u1(12), u3(4), &
  u0(13), u0(14), u1(13), u1(14), u3(5), &
  u1(15), u1(16), u1(17) /)
return
END SUBROUTINE mg631_prims
