...
if (size(r,1).ne.nk.or.size(r,2).ne.nk.or.size(u).ne.nr) then
 stop 'mg421111_prims: bad dimensions'
endif
...
u11(0) = x(ib0+m+n+1)
ib0 = ib0+m+n+2
call sym4_prims (x(ib0:ib0+m-1), u12)
...
u = (/ u0(0), u1(0), u2(0), u3(0), u4(0), u5(0), u6(0), u7(0), &
  ...
  u0(3), u0(4), u1(4), u3(2), u5(2), u8(2), u12(2), &
  u0(5), u1(5), u1(6), u3(3), u5(3), u8(3), u12(3), &
  u1(7) /)
return
END SUBROUTINE mg421111_prims
