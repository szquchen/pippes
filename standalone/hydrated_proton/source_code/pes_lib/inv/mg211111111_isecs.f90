SUBROUTINE mg211111111_isecs (mxd, r, pv)
...
if (size(r).ne.nk*nk) then
 stop 'mg211111111_isecs: bad dimensions'
endif
call mgx_setd (r, d)
pv = 0
j0 = m ; k0 = j0+1 ; l0 = k0+1 ; m0 = l0+1
n0 = m0+1 ; o0 = n0+1 ; p0 = o0+1 ; q0=p0+1
do i0 = 0, m-1
 do i1 = 0, m-1
  if (i1.ne.i0) then
   call mg211111111_all (mxd, mm)
  endif
 enddo
enddo
return
CONTAINS
SUBROUTINE mg211111111_all (mxd, mu)
...
if (2.le.mxd) then
 ...
 pv(21) = pv(21)+d(i0,j0)*d(i0,q0)/mu
 pv(22) = pv(22)+d(i0,k0)*d(i0,q0)/mu
 pv(23) = pv(23)+d(i0,l0)*d(i0,q0)/mu
 pv(24) = pv(24)+d(i0,m0)*d(i0,q0)/mu
 pv(25) = pv(25)+d(i0,n0)*d(i0,q0)/mu
 pv(26) = pv(26)+d(i0,o0)*d(i0,q0)/mu
 pv(27) = pv(27)+d(i0,p0)*d(i0,q0)/mu
endif
END SUBROUTINE mg211111111_all
END SUBROUTINE mg211111111_isecs
