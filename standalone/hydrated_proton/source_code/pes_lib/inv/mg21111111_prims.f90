SUBROUTINE mg21111111_prims (r, u)
...
real (kind=wp) :: x(0:nr-1), u0(0:m2-1), u1(0:m-1), u2(0:m-1), u3(0:0), &
  ...
  u11(0:m-1), u12(0:0), u13(0:0), u14(0:0), u15(0:0), u16(0:m-1), &
  u17(0:0), u18(0:0), u19(0:0), u20(0:0), u21(0:0), &
  u22(0:m-1), u23(0:0), u24(0:0), u25(0:0), u26(0:0), u27(0:0), u28(0:0)
if (size(r,1).ne.nk.or.size(r,2).ne.nk.or.size(u).ne.nr) then
 stop 'mg21111111_prims: bad dimensions'
endif
...
u = (/ u0(0), u1(0), u2(0), u3(0), u4(0), u5(0), u6(0), u7(0), u8(0), &
  ...
  u1(1), u2(1), u4(1), u7(1), u11(1), u16(1), u22(1) /)
return
END SUBROUTINE mg21111111_prims
