FUNCTION pes_x5y2z1_pot (xn) RESULT (f)
! Potential for generic X5Y2Z1
real (kind=wp), intent (in) :: xn(0:,0:)
real (kind=wp) :: f
!-----------------------------------------------------------------------
real (kind=wp) :: r(0:pes_x5y2z1_nk-1,0:pes_x5y2z1_nk-1)
integer, parameter :: nki(0:2)=pes_x5y2z1_nki
call pes_dists (xn, r)
f = pes_x1_cf*nki(0)+pes_y1_cf*nki(1)+pes_z1_cf*nki(2)+ &
  ...
  cx_f521(nki,r,pes_x5y2z1_pc,pes_x5y2z1_cf)
return
END FUNCTION pes_x5y2z1_pot
