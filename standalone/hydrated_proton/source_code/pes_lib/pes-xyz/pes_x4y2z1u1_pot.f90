FUNCTION pes_x4y2z1u1_pot (xn) RESULT (f)
! Potential for generic X4Y2Z1U1
...
f = pes_x1_cf*nki(0)+ &
  ...
  cx_f4201(nki,r,pes_x4y2u1_pc,pes_x4y2u1_cf)+ &
  cx_f4111(nki,r,pes_x4y1z1u1_pc,pes_x4y1z1u1_cf)+ &
  cx_f3211(nki,r,pes_x3y2z1u1_pc,pes_x3y2z1u1_cf)+ &
  cx_f4211(nki,r,pes_x4y2z1u1_pc,pes_x4y2z1u1_cf)
return
END FUNCTION pes_x4y2z1u1_pot
