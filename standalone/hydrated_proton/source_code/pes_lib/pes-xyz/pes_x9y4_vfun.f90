FUNCTION pes_x9y4_vfun (xn) RESULT (f)
! Vector function for generic X9Y4
real (kind=wp), intent (in) :: xn(0:,0:)
real (kind=wp) :: f(0:size(xn,2)-1)
!-----------------------------------------------------------------------
real (kind=wp) :: r(0:pes_x9y4_nk-1,0:pes_x9y4_nk-1)
integer, parameter :: nki(0:1)=pes_x9y4_nki
call pes_dists (xn, r)
...
!!  cxv_f61(nki,r,pes_x6y1_vpc,pes_x6y1_vcf)+ &
  cxv_f52(nki,r,pes_x5y2_vpc,pes_x5y2_vcf)
!!  cxv_f43(nki,r,pes_x4y3_vpc,pes_x4y3_vcf)+ &
!!  cxv_f71(nki,r,pes_x7y1_vpc,pes_x7y1_vcf)+ &
!!  cxv_f62(nki,r,pes_x6y2_vpc,pes_x6y2_vcf)+ &
!!  cxv_f53(nki,r,pes_x5y3_vpc,pes_x5y3_vcf)+ &
!!  cxv_f72(nki,r,pes_x7y2_vpc,pes_x7y2_vcf)+ &
!!  cxv_f63(nki,r,pes_x6y3_vpc,pes_x6y3_vcf)+ &
!!  cxv_f73(nki,r,pes_x7y3_vpc,pes_x7y3_vcf)
return
END FUNCTION pes_x9y4_vfun
