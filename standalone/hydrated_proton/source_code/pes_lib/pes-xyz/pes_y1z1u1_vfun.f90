FUNCTION pes_y1z1u1_vfun (xn) RESULT (f)
! Vector function for generic Y1Z1U1
...
f = cxv_f1(nki,pes_y1_vcf)+ &
  ...
  cxv_f101(nki,r,pes_y1u1_vpc,pes_y1u1_vcf)+ &
  cxv_f011(nki,r,pes_z1u1_vpc,pes_z1u1_vcf)+ &
  cxv_f111(nki,r,pes_y1z1u1_vpc,pes_y1z1u1_vcf)
return
END FUNCTION pes_y1z1u1_vfun
