FUNCTION pes_x5y1z1u1_pot (xn) RESULT (f)
! Potential for generic X5Y1Z1U1
real (kind=wp), intent (in) :: xn(0:,0:)
real (kind=wp) :: f
!-----------------------------------------------------------------------
real (kind=wp) :: r(0:pes_x5y1z1u1_nk-1,0:pes_x5y1z1u1_nk-1)
integer, parameter :: nki(0:3)=pes_x5y1z1u1_nki
call pes_dists (xn, r)
f = pes_x1_cf*nki(0)+pes_y1_cf*nki(1)+pes_z1_cf*nki(2)+ &
  ...
  cx_f501(nki,r,pes_x5z1_pc,pes_x5z1_cf)+ &
  cx_f411(nki,r,pes_x4y1z1_pc,pes_x4y1z1_cf)+ &
  cx_f5001(nki,r,pes_x5u1_pc,pes_x5u1_cf)+ &
  ...
  cx_f511(nki,r,pes_x5y1z1_pc,pes_x5y1z1_cf)+ &
  cx_f5101(nki,r,pes_x5y1u1_pc,pes_x5y1u1_cf)+ &
  cx_f5011(nki,r,pes_x5z1u1_pc,pes_x5z1u1_cf)+ &
  cx_f4111(nki,r,pes_x4y1z1u1_pc,pes_x4y1z1u1_cf)+ &
  cx_f5111(nki,r,pes_x5y1z1u1_pc,pes_x5y1z1u1_cf)
return
END FUNCTION pes_x5y1z1u1_pot
