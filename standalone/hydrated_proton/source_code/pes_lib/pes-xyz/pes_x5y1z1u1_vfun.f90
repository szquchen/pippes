FUNCTION pes_x5y1z1u1_vfun (xn) RESULT (f)
! Vector function for generic X5Y1Z1U1
...
f = cxv_f1(nki,pes_x1_vcf)+ &
  ...
  cxv_f5001(nki,r,pes_x5u1_vpc,pes_x5u1_vcf)+ &
  ...
  cxv_f5101(nki,r,pes_x5y1u1_vpc,pes_x5y1u1_vcf)+ &
  cxv_f5011(nki,r,pes_x5z1u1_vpc,pes_x5z1u1_vcf)+ &
  cxv_f4111(nki,r,pes_x4y1z1u1_vpc,pes_x4y1z1u1_vcf)+ &
  cxv_f5111(nki,r,pes_x5y1z1u1_vpc,pes_x5y1z1u1_vcf)
return
END FUNCTION pes_x5y1z1u1_vfun
