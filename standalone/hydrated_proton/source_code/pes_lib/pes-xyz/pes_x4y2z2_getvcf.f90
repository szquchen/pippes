SUBROUTINE pes_x4y2z2_getvcf (nki, nkj, pc, cf)
...
if (size(nki).ne.size(pes_x4y2z2_nki)) then
 stop 'pes_x4y2z2_getvcf: bad dimension'
else if (any(nki.ne.pes_x4y2z2_nki)) then
 stop 'pes_x4y2z2_getvcf: bad nki'
endif
if (all(nkj.eq.(/1,0,0/))) then
 ...
 call pes_x4z2_vadd (pc, cf)
 call pes_write (iun, 'vpcf-x4z2', pes_x4z2_vpc, pes_x4z2_vcf)
 ...
 call pes_x4y1z2_vadd (pc, cf)
 call pes_write (iun, 'vpcf-x4y1z2', pes_x4y1z2_vpc, pes_x4y1z2_vcf)
 ...
 call pes_x4y2z2_vadd (pc, cf)
 call pes_write (iun, 'vpcf-x4y2z2', pes_x4y2z2_vpc, pes_x4y2z2_vcf)
else
 stop 'pes_x4y2z2_getvcf: bad nkj'
end if
return
END SUBROUTINE pes_x4y2z2_getvcf
