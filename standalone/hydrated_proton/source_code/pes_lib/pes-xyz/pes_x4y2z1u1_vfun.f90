FUNCTION pes_x4y2z1u1_vfun (xn) RESULT (f)
! Vector function for generic X4Y2Z1U1
real (kind=wp), intent (in) :: xn(0:,0:)
real (kind=wp) :: f(0:size(xn,2)-1)
!-----------------------------------------------------------------------
real (kind=wp) :: r(0:pes_x4y2z1u1_nk-1,0:pes_x4y2z1u1_nk-1)
integer, parameter :: nki(0:3)=pes_x4y2z1u1_nki
call pes_dists (xn, r)
f = cxv_f1(nki,pes_x1_vcf)+ &
  ...
  cxv_f4201(nki,r,pes_x4y2u1_vpc,pes_x4y2u1_vcf)+ &
  cxv_f421(nki,r,pes_x4y2z1_vpc,pes_x4y2z1_vcf)+ &
  cxv_f4201(nki,r,pes_x4y2u1_vpc,pes_x4y2u1_vcf)+ &
  cxv_f4111(nki,r,pes_x4y1z1u1_vpc,pes_x4y1z1u1_vcf)+ &
  cxv_f3211(nki,r,pes_x3y2z1u1_vpc,pes_x3y2z1u1_vcf)+ &
  cxv_f4211(nki,r,pes_x4y2z1u1_vpc,pes_x4y2z1u1_vcf)
return
END FUNCTION pes_x4y2z1u1_vfun
