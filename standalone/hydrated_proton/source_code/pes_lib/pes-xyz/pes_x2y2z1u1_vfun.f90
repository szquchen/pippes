FUNCTION pes_x2y2z1u1_vfun (xn) RESULT (f)
! Vector function for generic X2Y2Z1U1
real (kind=wp), intent (in) :: xn(0:,0:)
real (kind=wp) :: f(0:size(xn,2)-1)
!-----------------------------------------------------------------------
real (kind=wp) :: r(0:pes_x2y2z1u1_nk-1,0:pes_x2y2z1u1_nk-1)
integer, parameter :: nki(0:3)=pes_x2y2z1u1_nki
call pes_dists (xn, r)
...
return
END FUNCTION pes_x2y2z1u1_vfun
