SUBROUTINE pes_x4y2z1u1_getvcf (nki, nkj, pc, cf)
...
if (size(nki).ne.size(pes_x4y2z1u1_nki)) then
 stop 'pes_x4y2z1u1_getvcf: bad dimension'
else if (any(nki.ne.pes_x4y2z1u1_nki)) then
 stop 'pes_x4y2z1u1_getvcf: bad nki'
endif
if (all(nkj.eq.(/1,0,0,0/))) then
 ...
 call pes_y2u1_vadd (pc, cf)
 call pes_write (iun, 'vpcf-y2u1', pes_y2u1_vpc, pes_y2u1_vcf)
 ...
 call pes_x1y2u1_vadd (pc, cf)
 call pes_write (iun, 'vpcf-x1y2u1', pes_x1y2u1_vpc, pes_x1y2u1_vcf)
 ...
 call pes_write (iun, 'vpcf-x1y1z1u1', pes_x1y1z1u1_vpc, pes_x1y1z1u1_vcf)
else if (all(nkj.eq.(/0,2,1,1/))) then
 call pes_y2z1u1_vadd (pc, cf)
 call pes_write (iun, 'vpcf-y2z1u1', pes_y2z1u1_vpc, pes_y2z1u1_vcf)
 ...
 call pes_x2y2u1_vadd (pc, cf)
 call pes_write (iun, 'vpcf-x2y2u1', pes_x2y2u1_vpc, pes_x2y2u1_vcf)
 ...
 call pes_write (iun, 'vpcf-x2y1z1u1', pes_x2y1z1u1_vpc, pes_x2y1z1u1_vcf)
else if (all(nkj.eq.(/1,2,1,1/))) then
 call pes_x1y2z1u1_vadd (pc, cf)
 call pes_write (iun, 'vpcf-x1y2z1u1', pes_x1y2z1u1_vpc, pes_x1y2z1u1_vcf)
 ...
 call pes_x3y2u1_vadd (pc, cf)
 call pes_write (iun, 'vpcf-x3y2u1', pes_x3y2u1_vpc, pes_x3y2u1_vcf)
 ...
 call pes_write (iun, 'vpcf-x3y1z1u1', pes_x3y1z1u1_vpc, pes_x3y1z1u1_vcf)
else if (all(nkj.eq.(/2,2,1,1/))) then
 call pes_x2y2z1u1_vadd (pc, cf)
 call pes_write (iun, 'vpcf-x2y2z1u1', pes_x2y2z1u1_vpc, pes_x2y2z1u1_vcf)
else if (all(nkj.eq.(/4,2,1,0/))) then
 call pes_x4y2z1_vadd (pc, cf)
 call pes_write (iun, 'vpcf-x4y2z1', pes_x4y2z1_vpc, pes_x4y2z1_vcf)
else if (all(nkj.eq.(/4,2,0,1/))) then
 call pes_x4y2u1_vadd (pc, cf)
 call pes_write (iun, 'vpcf-x4y2u1', pes_x4y2u1_vpc, pes_x4y2u1_vcf)
 ...
 call pes_x3y2z1u1_vadd (pc, cf)
 call pes_write (iun, 'vpcf-x3y2z1u1', pes_x3y2z1u1_vpc, pes_x3y2z1u1_vcf)
else if (all(nkj.eq.(/4,2,1,1/))) then
 call pes_x4y2z1u1_vadd (pc, cf)
 call pes_write (iun, 'vpcf-x4y2z1u1', pes_x4y2z1u1_vpc, pes_x4y2z1u1_vcf)
else
 stop 'pes_x4y2z1u1_getvcf: bad nkj'
end if
return
END SUBROUTINE pes_x4y2z1u1_getvcf
