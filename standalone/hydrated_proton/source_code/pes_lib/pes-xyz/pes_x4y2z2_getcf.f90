SUBROUTINE pes_x4y2z2_getcf (nki, nkj, pc, cf)
...
integer :: iun
call pes_getiun (iun)
if (size(nki).ne.size(pes_x4y2z2_nki)) then
 stop 'pes_x4y2z2_getcf: bad dimension'
else if (any(nki.ne.pes_x4y2z2_nki)) then
 stop 'pes_x4y2z2_getcf: bad nki'
endif
...
else if (all(nkj.eq.(/4,0,2/))) then
 call pes_x4z2_add (pc, cf)
 call pes_write (iun, 'pcf-x4z2', pes_x4z2_pc, pes_x4z2_cf)
...
else if (all(nkj.eq.(/4,1,2/))) then
 call pes_x4y1z2_add (pc, cf)
 call pes_write (iun, 'pcf-x4y1z2', pes_x4y1z2_pc, pes_x4y1z2_cf)
else if (all(nkj.eq.(/3,2,2/))) then
 call pes_x3y2z2_add (pc, cf)
 call pes_write (iun, 'pcf-x3y2z2', pes_x3y2z2_pc, pes_x3y2z2_cf)
else if (all(nkj.eq.(/4,2,2/))) then
 call pes_x4y2z2_add (pc, cf)
 call pes_write (iun, 'pcf-x4y2z2', pes_x4y2z2_pc, pes_x4y2z2_cf)
else
 stop 'pes_x4y2z2_getcf: bad nkj'
end if
return
END SUBROUTINE pes_x4y2z2_getcf
